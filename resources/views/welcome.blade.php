...
<body class="index-page">
  ...
  <main class="main">
    ...
    <h3>Sistem Manajemen Tugas Karyawan Berbasis Web</h3>

    <p class="fst-italic">
        M-TUGAS hadir sebagai solusi digital untuk membantu perusahaan dalam mengelola pembagian tugas, memantau progres pekerjaan, dan meningkatkan produktivitas karyawan secara terstruktur.
    </p>

    <ul>
        <li>
            <i class="bi bi-check2-all"></i>
            <span>Mengelola data pengguna yang terdiri dari administrator dan karyawan.</span>
        </li>

        <li>
            <i class="bi bi-check2-all"></i>
            <span>Memberikan tugas kepada karyawan lengkap dengan deskripsi dan batas waktu pengerjaan.</span>
        </li>

        <li>
            <i class="bi bi-check2-all"></i>
            <span>Memantau status tugas mulai dari Belum Dikerjakan, Sedang Dikerjakan, hingga Selesai secara real-time.</span>
        </li>

        <li>
            <i class="bi bi-check2-all"></i>
            <span>Membantu perusahaan meningkatkan efisiensi koordinasi dan pengawasan pekerjaan.</span>
        </li>
    </ul>

    <p>
        Dengan M-TUGAS, proses pengelolaan pekerjaan menjadi lebih mudah, transparan, dan terorganisir. Administrator dapat mendistribusikan tugas dengan cepat, sementara karyawan dapat melihat serta menyelesaikan tugas yang diberikan sesuai target waktu yang telah ditentukan.
    </p>
</div>
        ...
        <div class="row gy-4">
          ...
          <div class="col-xl-12">
            ...
            <div class="info-wrap">
              ...
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.6670969494617!2d106.82453567411314!3d-6.175302960510653!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f5d2e764b12d%3A0x3d2ad6e1e0e9bcc8!2sMonumen%20Nasional!5e0!3m2!1sid!2sid!4v1781952044960!5m2!1sid!2sid" 
